      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Klampok, Singosari</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp29.500</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>18 juli, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={scooter}
            style={home.icon}
